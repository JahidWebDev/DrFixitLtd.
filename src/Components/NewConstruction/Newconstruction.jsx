...
const Newconstruction = () => {
  ...
  const products = [
    {
      ...
      type: "repair",
      imgs: [product1],
      description: "1 Liter Waterproofing Expert",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      type: "repair",
      imgs: [product3],
      description: "18 Liter Waterproofing Expert",
    },
    {
      id: 6,
      name: "Dr Fixit Brand 302 Super Latex",
    ...
    },
    {
      ...
      type: "repair",
      imgs: [product2],
      description: "18 Liter Plaster Expert",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      category: "Cleaner",
      imgs: [product11],
      description: "1 Liter Muilti-Purpase Rust Remover",
    },
    {
      id: 13,
      ...
      category: "Glue",
      imgs: [product9],
      description: "500ml Liter Bonding Expert",
    },
  ];
  ...
  const leakageOptions = [
    ...
    "Wall",
    "Woodworking",
    "Crack filling (If Any)",
  ];

  // Filtered products based on tab, leakage, and search
  const filteredProducts = products.filter((p) => {
    const matchesTab =
      activeTab === "repair" ? p.type === "repair" : p.type === "new";
      ...
      <section className="py-30 px-4 md:px-8 lg:px-12">
        <div className="max-w-[1500px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Sidebar Filter */}
            <aside
              className="md:col-span-1 ju rounded-2xl shadow-xl p-6 border border-gray-200 
