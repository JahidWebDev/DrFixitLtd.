    ...
    <header className="relative min-h-screen overflow-hidden">
      ...
      >
        <nav className="flex items-center justify-between py-4">
          ...
          {/* Mobile Menu */}
          {menuOpen && (
            <div className="absolute top-20 right-4 w-64 bg-white rounded-lg shadow-xl p-4 z-30 md:hidden
">
...
">
  ...
  <div className="
    ...
    md:pr-0.5 
  ">
    <h2 className="text-2xl sm:text-3xl md:text-3xl font-semibold leading-snug ">
      <span className="lg:text-yellow-300 text-white font-bold">DR. FIXIT LTD.</span>{" "}
      offers comprehensive range of products to meet all your waterproofing needs
    </h2>

    <div className="
      flex flex-wrap gap-6
      text-lg sm:text-xl font-semibold mt-4
...
>
  Please Return My Call
    ...
    {/* Bottom Info */}
<div className="mt-8 sm:mt-5 text-center md:text-left">
  <p
    className="
  ...
  >
    ...
    <span className="font-bold text-[#111] text-sm sm:text-[18px]">
      +8801788360303
    </span>
  </p>
</div>
